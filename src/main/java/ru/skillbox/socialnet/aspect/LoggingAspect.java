...
public class LoggingAspect {
    @Around("ru.skillbox.socialnet.aspect.LoggingPointcuts.springBeanPointcut() && " +
            "ru.skillbox.socialnet.aspect.LoggingPointcuts.applicationPackagePointcut() && " +
            "ru.skillbox.socialnet.aspect.AnnotationPointcuts.info()")
    ...
    @Around("ru.skillbox.socialnet.aspect.LoggingPointcuts.springBeanPointcut() && " +
            "ru.skillbox.socialnet.aspect.LoggingPointcuts.applicationPackagePointcut() && " +
            "ru.skillbox.socialnet.aspect.AnnotationPointcuts.debug()")
