...
drop table if exists posts cascade;
    ...
    create table persons (
     ...
     telegram_id bigint,
     person_settings_id bigint, /*TODO not null parameter removed*/
     unique (e_mail),
     primary key (id)
    );
    ...
    create table posts (
     ...
     primary key (id)
        ...
        --TODO remove redundant records
        insert into persons (id, first_name, last_name, e_mail, phone, reg_date, birth_date, city, country, deleted_time, last_online_time, is_approved, is_blocked, is_deleted, person_settings_id, password, message_permissions, online_status)
            values (1, 'Ella', 'Chaplin', 'echaplin0@thetimes.co.uk', '+505-472-972-1137', '2023-07-26 22:25:20', '2006/08/28', 'Las Sabanas', 'Nicaragua', null, '2023-09-15 17:06:48', true, false, false, 1, 'MSFnNmswZjQ=', 'ALL', false);
        insert into persons (id, first_name, last_name, e_mail, phone, reg_date, birth_date, city, country, deleted_time, last_online_time, is_approved, is_blocked, is_deleted, person_settings_id, password, message_permissions, online_status)
            values (2, 'Adriaens', 'Whillock', 'awhillock1@gov.uk', '+48-832-911-0867', '2023-01-02 18:51:39', '1989/05/26', 'Dobczyce', 'Poland', null, '2023-08-01 00:59:05', true, false, false, 2, 'MSFnNmswZjQ=', 'ALL', false);
        insert into persons (id, first_name, last_name, e_mail, phone, reg_date, birth_date, city, country, deleted_time, last_online_time, is_approved, is_blocked, is_deleted, person_settings_id, password, message_permissions, online_status)
            values (3, 'Ailsun', 'Asbury', 'aasbury2@paginegialle.it', '+46-328-795-3579', '2023-06-13 19:02:09', '2008/02/24', 'Stockholm', 'Sweden', null, null, true, false, false, 3, 'MSFnNmswZjQ=', 'ALL', false);

        --Blocked and deleted user
        insert into persons (id, first_name, last_name, e_mail, phone, reg_date, birth_date, city, country, deleted_time, last_online_time, is_approved, is_blocked, is_deleted, person_settings_id, password, message_permissions, online_status)
            values (4, 'Kerr', 'Morena', 'kmorena3@nationalgeographic.com', '+381-453-175-4645', '2023-05-26 09:22:42', '2015/02/15', 'Trstenik', 'Serbia', null, '2023-09-25 05:04:56', false, true, true, 4, 'MSFnNmswZjQ=', 'ALL', false);
