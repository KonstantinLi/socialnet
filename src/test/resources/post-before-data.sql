...
--insert into persons (first_name, last_name, e_mail, phone, reg_date, birth_date, city, country, deleted_time, last_online_time, is_approved, is_blocked, is_deleted, person_settings_id, password, message_permissions, online_status) values ('July', 'Moon', 'jmoon0@thetimes.co.uk', '+505-472-972-1144', '2023-07-12 22:25:20', '2000/08/12', 'Las Sabanas', 'Nicaragua', null, '2023-09-15 17:06:48', false, false, false, 3, 'MSFnNmswZjQ=', 'ALL', false);
...
--insert into posts (author_id, is_blocked, is_deleted, time, title, post_text) values (3, true, false, '2023-12-30 23:47:43', 'post 3', 'text test post 3');
